CREATE TABLE IF NOT EXISTS `flightstable` (
  ...
  `Manufacturer` varchar(60) CHARACTER SET utf8 DEFAULT NULL,
  `OperatorCode` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `SerialNo` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `YearBuilt` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
